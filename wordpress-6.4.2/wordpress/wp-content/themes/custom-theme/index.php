    ...
    <div class="slide">
        ...
        <div class="categories">
            ...
            <div class="category">
                <i class="icon"></i>
                <h4>SEO & Marketing</h4>
                <p>A process of affecting the visibility of a website<br>or a web search engine's<br>unpaid results.</p>
            </div>
        </div>
    </div>
</div>
...
<div class="industries-container">
    <div class="industries-left">
        ...
        <p>An award-winning design and development team that is<br>proud of our work.</p>
        <ul>
            <li><i class="icon checkmark-icon"></i> Donec malesuada odio nulla, fringilla varius</li>
            <li><i class="icon checkmark-icon"></i> Quisque blandit, nulla ut convallis consequat, metus ligula</li>
            <li><i class="icon checkmark-icon"></i> Vivamus luctus mauris eu sem maximus, a efficitur</li>
            <li><i class="icon checkmark-icon"></i> Sed feugiat, est fringilla hendrerit egestas, massa facilisis</li>
            <li><i class="icon checkmark-icon"></i> Aenean egestas elit nec ante consectetur pretium</li>
        </ul>
    </div>
